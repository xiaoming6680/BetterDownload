...
当前为 **0.4.1 预发布版**。自动化转换测试与界面回归已通过，设置页已在 BetterNCM 1.3.4 加载；完整真实 NCM 下载转换验收仍待完成。
...
Windows、BetterNCM >= 1.3.4、.NET Framework 4.6.2 或更新版本。下载接口面向网易云 3.x，已对照本机 3.1.37 前端源码核对，但尚未进行真实客户端下载验收，也不保证全部 3.x 版本适用。未找到 SDK 时设置页提示等待接口，不会改为目录扫描。
